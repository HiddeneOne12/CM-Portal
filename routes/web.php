...
Route::middleware(['web', 'xss'])->group(function () {
    ...
    // Visitor analytics (record visit / time spent)
    Route::post('/record-visit', [VisitorAnalyticsController::class, 'store'])->name('visitor.record');
    Route::post('/record-visit/{id}/time', [VisitorAnalyticsController::class, 'updateTime'])->name('visitor.update-time');
    ...
    // Admin: URL prefix /cmcontrol, route name prefix admin.
    Route::prefix('cmcontrol')->name('admin.')->group(function () {
        ...
        Route::middleware(['admin'])->group(function () {
            ...
            |--------------------------------------------------------------------------
            */
            Route::get('/acl/roles', [RoleController::class, 'index'])->name('acl.roles.listing');
            Route::get('/acl/roles/add', [RoleController::class, 'create'])->name('acl.roles.add');
            Route::post('/acl/roles/add', [RoleController::class, 'store']);
            Route::get('/acl/roles/edit/{token}', [RoleController::class, 'edit'])->name('acl.roles.edit');
            Route::post('/acl/roles/edit/{token}', [RoleController::class, 'update']);
            Route::post('/acl/roles/delete/{token}', [RoleController::class, 'destroy'])->name('acl.roles.delete');

            /*
            |--------------------------------------------------------------------------
            | Admin Users (ACL)
            | Group prefix is already admin. so names here become:
            |   admin.acl.admin-users.listing
            |   admin.acl.admin-users.add  etc.
            |--------------------------------------------------------------------------
            */
            Route::get('/acl/admin-users', [AdminUserController::class, 'index'])->name('acl.admin-users.listing');
            Route::get('/acl/admin-users/add', [AdminUserController::class, 'create'])->name('acl.admin-users.add');
            Route::post('/acl/admin-users/add', [AdminUserController::class, 'store'])->name('acl.admin-users.store');
            Route::get('/acl/admin-users/edit/{token}', [AdminUserController::class, 'edit'])->name('acl.admin-users.edit');
            Route::post('/acl/admin-users/edit/{token}', [AdminUserController::class, 'update']);
            Route::post('/acl/admin-users/delete/{token}', [AdminUserController::class, 'destroy'])->name('acl.admin-users.delete');

            /*
            |--------------------------------------------------------------------------
            | Module Categories (ACL)
            |--------------------------------------------------------------------------
            */
