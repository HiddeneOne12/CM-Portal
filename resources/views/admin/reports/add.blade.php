<form method="post" action="{{ url('/cmcontrol/acl/reports/add') }}" enctype="multipart/form-data">
    @csrf
    ...
    <div class="fv-row mb-5">
        ...
        <input type="text" name="title" class="form-control form-control-solid" placeholder="Report title" required />
    </div>
    <div class="fv-row mb-5">
        <label class="fs-6 fw-semibold mb-2">Description</label>
        <textarea name="description" class="form-control form-control-solid" rows="4" placeholder="Brief description for the report card"></textarea>
    </div>
    <div class="fv-row mb-5">
